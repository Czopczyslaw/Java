...
public class MyServlet extends HttpServlet {
    ...
    public void init() {
        ...
        /*
                appData.addUser(new User("Paweł","Kruszyński"));
                appData.addUser(new User("Gaweł","Maciejowski"));
                appData.addUser(new User("Wiktor","Wiktoriański"));
                appData.addUser(new User("Marceli","Sobota"));
         */
